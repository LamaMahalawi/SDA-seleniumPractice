...
//Different ways to Calculation in severy test()
    @Test
...
//        Click on Calculate
        new Select(driver.findElement(By.id("function"))).selectByVisibleText("divide");driver.findElement(By.id("calculate")).click();
